...
insert into pessoa (id, nome, ativo) values (1, 'Igor', 'S')
insert into pessoa (id, nome, ativo) values (2, 'Miriam', 'N')
insert into pessoa (id, nome, ativo) values (3, 'Beto', null)
insert into pessoa (id, nome, ativo) values (4, 'Maria', 'n')
